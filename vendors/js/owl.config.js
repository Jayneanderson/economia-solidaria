...
$('.owl-carousel').owlCarousel({
    ...
    dots: false,
    navText: ['<img id="arrow-prev" src="assets/img/arrow_back.svg" alt="Seta para a esqueda">','<img id="arrow-next" src="assets/img/arrow_forward.svg" alt="Seta para a direita">'],
    responsive: {
        0: {
            items: 1
        },
